			...
			<div class="s_tittle"><i><a style="color: #7eb9be" href="./index.php?click=info">Profile</a> > Change Password</i></div>
				...
				<ul class="ul_pass">
					<li class="li_current row">
						...
						<input name='currentPass' id='currentPass' class="form-input col-md-6" type="Password"
						oninput=CheckPass()>		
						<span id='notice'></span>
					</li>
					<li class="li_new row">
						<div class="ul_info_1"><span class="label_info  col-md-4">New</span></div>
						<input name='newPass' class="form-input col-md-6" type="Password"
						id='newPass' > 
					</li>
					<li class="li_retype row">
						<div class="ul_info_1 "><span class="label_info col-md-4">Confirm</span></div>
						<input name='retypePass' class="form-input col-md-6" type="Password"
						id='retypePass' oninput = CheckRetype()><span id='notice2'></span>
					</li>
				</ul>
